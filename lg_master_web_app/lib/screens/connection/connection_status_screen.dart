...
class ConnectionStatusScreen extends StatelessWidget {
  ...
  const ConnectionStatusScreen({
    ...
    required this.ipAddress, // 'required' makes that the ipAddress value is always provided
    required this.port, // 'required' makes that the port value is always provided
    required this.isConnected, // 'required' makes that the value of the connection (true or false) is always provided
  });
