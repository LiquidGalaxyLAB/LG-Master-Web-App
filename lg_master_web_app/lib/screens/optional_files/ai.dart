// -------------------------------------------- AI SCREEN --------------------------------------------
// This screen gives information about how to integrates AI on your project to generate responses based on prompts
...
class _AIScreenState extends State<AIScreen> {
  ...
  Future<void> _sendPrompt() async {
    ...
    try {
      ...
      // Keep in mind this is the structure for Gemini API, other models may have other strcutures
