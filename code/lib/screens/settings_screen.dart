// Screen dedicated to the settings section
...
// SettingsScreen class is the root widget of the app's tree, and all other widgets are built from there
...
class SettingsScreen extends StatelessWidget {
  const SettingsScreen({super.key}); // 'super' indicates that, if this widget receives a key, it will be passed to the parent class so Flutter knows about it
