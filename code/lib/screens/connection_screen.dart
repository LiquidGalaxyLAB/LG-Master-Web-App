// Screen dedicated to the login of the user and the connection to the Liquid Galaxy
...
// ConnectionScreen class is the root widget of the app's tree, and all other widgets are built from there
...
class ConnectionScreen extends StatelessWidget {
  const ConnectionScreen({super.key}); // 'super' indicates that, if this widget receives a key, it will be passed to the parent class so Flutter knows about it
